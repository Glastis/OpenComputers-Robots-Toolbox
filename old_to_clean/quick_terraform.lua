...
function clean_inventory()
	...
	while slot <= robot.inventorySize() do
		data = component.inventory_controller.getStackInInternalSlot(slot)
		if data and (data.name == "minecraft:grass" or (data.name == "minecraft:dirt" and data.damage == 0) or data.name == "minecraft:stone_pickaxe" or data.name == "minecraft:log" or data.name == "minecraft:planks" or data.name == "minecraft:stick") then
...
function smart_swing()
	...
	if bloc.name == "minecraft:dirt" or bloc.name == "minecraft:sand" or bloc.name == "minecraft:grass" or bloc.name == "minecraft:gravel" then
		unequip()
...
function avance()
	...
	if not bloc or (bloc.name ~= "minecraft:dirt" and bloc.name ~= "minecraft:grass") then
		smart_swingDown()
	end
	if select_item("minecraft:dirt") or select_item("minecraft:grass") then
		robot.placeDown()
	end
...
print("Numbers of blocs to teraform in front of ?")
lenght = tonumber(io.read())
print("Numbers of blocs to teraform in a side ?")
